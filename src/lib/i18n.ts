...
export const TEXT = {
  ...
  loginSubtitle:  { zh: '登录履约通管理平台', en: 'Sign in to Settlement Connect' },
  loginUsername:  { zh: '用户名', en: 'Username' },
  loginPassword:  { zh: '密码', en: 'Password' },
  loginBtn:       { zh: '登录', en: 'Sign In' },
  loginDemo:      { zh: '演示账号', en: 'Demo Accounts' },
  loginDemoHint:  { zh: '点击快速填入', en: 'Click to autofill' },
  loginError:     { zh: '用户名或密码错误', en: 'Invalid username or password' },
  loginExpired:   { zh: '登录已过期，请重新登录', en: 'Session expired. Please sign in again.' },
  logout:         { zh: '退出登录', en: 'Sign Out' },
  logoutConfirm:  { zh: '确认退出登录？', en: 'Confirm sign out?' },
  modeStandalone: { zh: '独立模式', en: 'Standalone' },
  modeChain:      { zh: '链路模式', en: 'Chain' },
  chainFrom:      { zh: '来源', en: 'Source' },
  chainReturn:    { zh: '返回上游', en: 'Back to Main' },
  chainEntry:     { zh: '链路接入', en: 'Chain Entry' },
  chainBadge:     { zh: '链路', en: 'Chain' },
  userRole:       { zh: '角色', en: 'Role' },
  roleAdmin:      { zh: '管理员', en: 'Admin' },
  roleOperator:   { zh: '操作员', en: 'Operator' },
  roleViewer:     { zh: '查看者', en: 'Viewer' },
  navAudit:       { zh: '审计日志', en: 'Audit Logs' },
  auditTitle:     { zh: '审计日志', en: 'Audit Logs' },
  auditAction:    { zh: '操作', en: 'Action' },
  auditUser:      { zh: '用户', en: 'User' },
  auditTime:      { zh: '时间', en: 'Time' },
  auditPath:      { zh: '路径', en: 'Path' },
  auditMode:      { zh: '模式', en: 'Mode' },
  auditChainSrc:  { zh: '链路来源', en: 'Chain Source' },
  auditDetail:    { zh: '详情', en: 'Detail' },
  auditEmpty:     { zh: '暂无审计日志', en: 'No audit logs yet' },
} as const
